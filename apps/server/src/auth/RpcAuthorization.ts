...
export const RPC_REQUIRED_SCOPES = {
  ...
  [WS_METHODS.px0Meta]: AuthOrchestrationReadScope,
  [WS_METHODS.px0Tree]: AuthOrchestrationReadScope,
  [WS_METHODS.px0Find]: AuthOrchestrationReadScope,
  [WS_METHODS.px0File]: AuthOrchestrationReadScope,
  [WS_METHODS.px0Search]: AuthOrchestrationReadScope,
  [WS_METHODS.px0Outline]: AuthOrchestrationReadScope,
  [WS_METHODS.px0Diff]: AuthOrchestrationReadScope,
  [WS_METHODS.px0Gutter]: AuthOrchestrationReadScope,
